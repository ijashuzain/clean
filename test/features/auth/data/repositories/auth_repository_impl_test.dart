...
void main() {
  ...
  group('login', () {
    test(
      'should return AppUser when call to local datasource is successful',
      () async {
        // arrange
        when(
          mockAuthLocalDataSource.login(tEmail, tPassword),
    ...
    test(
      'should return Failure when call to local datasource throws an exception',
      () async {
        // arrange
        when(
          mockAuthLocalDataSource.login(tEmail, tPassword),
